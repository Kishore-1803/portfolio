          ...
          <div className={styles.projectsContainer}>
            ...
            <div className={styles.projectCard}>
              ...
              <div className={styles.projectInfo}>
                ...
                <p className={styles.projectDesc}>
                  An AI-powered developer performance analytics system. SyngenX connects to GitHub to deliver intelligent insights on individual strengths, team metrics, productivity, and criticality handling from real contributions.
                </p>
                <div className={styles.projectTags}>
